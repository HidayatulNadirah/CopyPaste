...
public class SessionInitial implements Runnable {
	...
	public void sendMainMenu1() throws IOException {
		String menu = "";
	...
	public void listDownAvailableSession() throws IOException {
		...
		if (!noAvailableSession) {
			...
			toClient.writeUTF("(" + ChatServer.availableSessions.size() + ") Back to Main Menu");
	...
	public void clientSelectedSession() throws IOException {
		...
		if (selectedSession >= 0 && selectedSession < ChatServer.availableSessions.size()) {
